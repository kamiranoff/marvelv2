...
import {ComicvineDCCharactersService} from "../../../services/comicvine/dc/comicvine-dc.service";
import {ComicvineDCAppearancesService} from "../../../services/comicvine/dc/comicvine-dc-appearance.service";
import {GraphComponent} from "../../../modules/graph/graph.component";

@Component({
  selector: 'ComicvinePageDC',
  providers: [ComicvineDCCharactersService,ComicvineDCAppearancesService,SearchAndFilterService],
...
export class ComicvineCharPageDC {
  ...
  constructor(private _comicvineDCCharacterService:ComicvineDCCharactersService,private _comicvineDCAppearancesService:ComicvineDCAppearancesService) {
    this.getCharacters();
    this.getAppearances();
