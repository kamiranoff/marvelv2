...
var comicvine_dc_service_1 = require("../../../services/comicvine/dc/comicvine-dc.service");
var comicvine_dc_appearance_service_1 = require("../../../services/comicvine/dc/comicvine-dc-appearance.service");
var graph_component_1 = require("../../../modules/graph/graph.component");
var ComicvineCharPageDC = (function () {
    function ComicvineCharPageDC(_comicvineDCCharacterService, _comicvineDCAppearancesService) {
        this._comicvineDCCharacterService = _comicvineDCCharacterService;
        this._comicvineDCAppearancesService = _comicvineDCAppearancesService;
        this.elems = [];
        this.searchTerm = '';
    ...
    ComicvineCharPageDC.prototype.getCharacters = function () {
        var _this = this;
    ...
    ComicvineCharPageDC.prototype.getMoreCharacters = function (lastName, qty) {
        var _this = this;
    ...
    ComicvineCharPageDC.prototype.getAppearances = function () {
        var _this = this;
        this._comicvineDCAppearancesService.getAppearancesFromDC()
    ...
    ComicvineCharPageDC.prototype.onSearchChanged = function (searchInput) {
        var _this = this;
        ...
        var keyups = Rx_1.Observable.of(searchInput)
            ...
            .flatMap(function (searchTerm) { return _this._comicvineDCCharacterService.searchCharactersByNameFromDC(searchTerm); });
        keyups.subscribe(function (data) {
            _this.elems = data;
            _this.isActive = false;
        });
    };
    ComicvineCharPageDC.prototype.onBottomOfPage = function ($event) {
    ...
    ComicvineCharPageDC = __decorate([
        core_1.Component({
            selector: 'ComicvinePageDC',
            providers: [comicvine_dc_service_1.ComicvineDCCharactersService, comicvine_dc_appearance_service_1.ComicvineDCAppearancesService, search_filter_service_1.SearchAndFilterService],
        ...
        __metadata('design:paramtypes', [comicvine_dc_service_1.ComicvineDCCharactersService, comicvine_dc_appearance_service_1.ComicvineDCAppearancesService])
    ], ComicvineCharPageDC);
    return ComicvineCharPageDC;
}());
exports.ComicvineCharPageDC = ComicvineCharPageDC;
