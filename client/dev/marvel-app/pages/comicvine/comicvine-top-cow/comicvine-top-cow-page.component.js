...
var comicvine_top_cow_service_1 = require("../../../services/comicvine/top-cow/comicvine-top-cow.service");
var comicvine_top_cow_appearance_service_1 = require("../../../services/comicvine/top-cow/comicvine-top-cow-appearance.service");
var graph_component_1 = require("../../../modules/graph/graph.component");
var ComicvineCharPageTopCow = (function () {
    function ComicvineCharPageTopCow(_comicvineTopCowCharacterService, _comicvineTopCowAppearancesService) {
        this._comicvineTopCowCharacterService = _comicvineTopCowCharacterService;
        this._comicvineTopCowAppearancesService = _comicvineTopCowAppearancesService;
        this.elems = [];
        this.searchTerm = '';
    ...
    ComicvineCharPageTopCow.prototype.getAppearances = function () {
        var _this = this;
    ...
    ComicvineCharPageTopCow = __decorate([
        core_1.Component({
            ...
            providers: [comicvine_top_cow_service_1.ComicvineTopCowCharactersService, comicvine_top_cow_appearance_service_1.ComicvineTopCowAppearancesService, search_filter_service_1.SearchAndFilterService],
        ...
        __metadata('design:paramtypes', [comicvine_top_cow_service_1.ComicvineTopCowCharactersService, comicvine_top_cow_appearance_service_1.ComicvineTopCowAppearancesService])
