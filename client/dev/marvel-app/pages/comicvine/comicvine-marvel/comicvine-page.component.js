...
var ComicvineCharPageMarvel = (function (_super) {
    __extends(ComicvineCharPageMarvel, _super);
    function ComicvineCharPageMarvel(_comicvineCharacterService, _comicvineAppearancesService) {
        _super.call(this, _comicvineCharacterService, _comicvineAppearancesService);
        this.page = "comicvineChars";
        this.characterServiceUrl = '/api/comicvine/marvel/characters';
        this.appearancesServiceUrl = 'api/comicvine/marvel/appearances';
    }
