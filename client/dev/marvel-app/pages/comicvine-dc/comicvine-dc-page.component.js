...
var comicvine_dc_service_1 = require("../../services/comicvine-dc.service");
var ComicvineCharPageDC = (function () {
    function ComicvineCharPageDC(_comicvineDCCharacterService) {
    ...
    ComicvineCharPageDC = __decorate([
        core_1.Component({
            ...
            providers: [comicvine_dc_service_1.ComicvineDCCharactersService, search_filter_service_1.SearchAndFilterService],
        ...
        __metadata('design:paramtypes', [comicvine_dc_service_1.ComicvineDCCharactersService])
    ], ComicvineCharPageDC);
