...
var ComicvineCharactersService = (function () {
    function ComicvineCharactersService(http) {
        this.http = http;
        this._heroesUrl = '/api/comicvine/characters';
    }
    ComicvineCharactersService.prototype.getCharacters = function () {
    ...
    ComicvineCharactersService.prototype.searchCharactersByName = function (userInput) {
